 ...
 *****************************************************************************/
/*!
  \file servoSimu3DCamVelocity2.cpp
...
/*!
  \example servoSimu3DCamVelocity2.cpp
  Simulation of a 3D visual servoing:
  - eye-in-hand control law,
  - velocity computed in the camera frame,
  - no display.
...
main(int argc, const char ** argv)
{
  ...
  task.addFeature(t,td) ;    // translation
  task.addFeature(tu,tud) ;  // rotation theta u
  ...
  while(iter++<200)
    {
      ...
      if (iter==1) 
	vpTRACE("\t\t compute the control law ") ;
