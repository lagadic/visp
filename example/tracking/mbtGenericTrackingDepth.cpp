  ...
  unsigned int &pointcloud_height)
{
...
#endif
  // Read image
  std::string filename_image = vpIoTools::toString(input_directory + "/image_%04d." + ext, cpt);
  ...
  // Read raw depth
  std::string filename_depth = vpIoTools::toString(input_directory + "/depth_image_%04d.bin", cpt);
