...
/*!
  ...
  Example of eye-in-hand image-based control law. We control here a real robot
  from Universal Robots. The velocity is computed in the camera frame. Visual features
