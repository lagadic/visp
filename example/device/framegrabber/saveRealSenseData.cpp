...
#if (defined (VISP_HAVE_REALSENSE) || defined (VISP_HAVE_REALSENSE2)) && (defined(VISP_HAVE_CXX11) || defined(VISP_HAVE_CXX14)) && (defined (VISP_HAVE_X11) || defined (VISP_HAVE_GDI))
