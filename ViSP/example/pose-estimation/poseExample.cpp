/****************************************************************************
 *
 * $Id: poseExample.cpp,v 1.1 2007-01-26 16:43:54 asaunier Exp $
 *
...
\param click : Set to false, disable the mouse click 
...
\n\
SYNOPSIS\n\
  %s [-i <input image path>] [-p <personal inmage path>]\n\
...
main(int argc, char** argv)
{
  ...
  cout <<  "-------------------------------------------------------" << endl ;
  cout <<  "  poseExample.cpp" <<endl << endl ;
