 ...
 * ===============
 *
 *  $Id: vpPoseExample.cpp,v 1.1 2005-11-30 11:16:46 marchand Exp $
 *
 * Description
 * ============
...
/*!
  ...
  \brief exampe of dots tracking in an image sequence and pose
  computation
*/
...
main()
{
  ...
  cout <<  "  exampe of dots tracking in an image sequence and pose computation" << endl ;
  cout <<  "-------------------------------------------------------" << endl ;
  cout << endl ;
