.. _tutorial-visual-servoing-franka:
...
The following :ref:`example <code-visual-servoing-franka>` detects an AprilTag using the RealSense camera
...
.. list-table::
  ...
  * - **Moving State**
    ...
    - **Stopping**
      ...
      .. image:: images/result-visual-servoing-franka-stop.png
