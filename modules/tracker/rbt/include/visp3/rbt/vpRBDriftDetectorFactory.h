...
/*!
  \file vpRBDriftDetectorFactory.h
  \brief Drift detection algorithm factory
*/
#ifndef VP_RB_DRIFT_DETECTOR_FACTORY_H
#define VP_RB_DRIFT_DETECTOR_FACTORY_H
...
public:
  ...
  {
    static vpRBDriftDetectorFactory factory;
    return factory;
  }
};
