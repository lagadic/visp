...
void vpTemplateTrackerWarpTranslation::getParamPyramidDown(
...
void vpTemplateTrackerWarpTranslation::getParamPyramidUp(const vpColVector &p,
                                                         vpColVector &pup)
{
  pup[0] = p[0] * 2.;
  pup[1] = p[1] * 2.;
 ...
 */
void vpTemplateTrackerWarpTranslation::getdW0(const int & /*i*/,
                                              const int & /*j*/,
                                              const double &dy,
 ...
 */
void vpTemplateTrackerWarpTranslation::getdWdp0(const int & /*i*/,
                                                const int & /*j*/,
                                                double *dIdW)
{
  dIdW[0] = 1.;
...
void vpTemplateTrackerWarpTranslation::warpX(const int &i, const int &j,
                                             double &i2, double &j2,
...
void vpTemplateTrackerWarpTranslation::warpX(const vpColVector &vX,
                                             vpColVector &vXres,
                                             const vpColVector &ParamM)
{
...
void vpTemplateTrackerWarpTranslation::dWarp(const vpColVector & /*X1*/,
 ...
 */
void vpTemplateTrackerWarpTranslation::dWarpCompo(
...
void vpTemplateTrackerWarpTranslation::warpXInv(const vpColVector &vX,
                                                vpColVector &vXres,
                                                const vpColVector &ParamM)
{
  vXres[0] = vX[0] + ParamM[0];
...
void vpTemplateTrackerWarpTranslation::getParamInverse(
...
void vpTemplateTrackerWarpTranslation::pRondp(const vpColVector &p1,
