...
public:
  ...
  //@{
  virtual void addCircle(const vpPoint &P1, const vpPoint &P2,
  ...
  virtual std::list<vpMbtDistanceCircle *> &
  getFeaturesCircle(const std::string &cameraName);

  virtual std::list<vpMbtDistanceKltPoints *> &getFeaturesKlt();
  virtual std::list<vpMbtDistanceKltPoints *> &
  getFeaturesKlt(const std::string &cameraName);

  virtual std::list<vpMbtDistanceKltCylinder *> &getFeaturesKltCylinder();
  virtual std::list<vpMbtDistanceKltCylinder *> &
  getFeaturesKltCylinder(const std::string &cameraName);

  virtual std::map<std::string, std::vector<vpImagePoint> >
  getKltImagePoints() const;

  virtual std::map<std::string, std::map<int, vpImagePoint> >
  getKltImagePointsWithId() const;

  virtual std::map<std::string, vpKltOpencv> getKltOpencv() const;

#if (VISP_HAVE_OPENCV_VERSION >= 0x020408)
  virtual std::map<std::string, std::vector<cv::Point2f> >
  getKltPoints() const;
#else
  ...
  */
  ...
  virtual void
  setKltOpencv(const std::map<std::string, vpKltOpencv> &mapOfOpenCVTrackers);
  ...
  */
  //@{
  /* vp_deprecated */ virtual std::map<std::string, int>
  getNbKltPoints() const;
