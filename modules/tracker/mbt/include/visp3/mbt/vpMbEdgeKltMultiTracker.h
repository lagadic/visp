...
*/
class VISP_EXPORT vpMbEdgeKltMultiTracker : public vpMbEdgeMultiTracker,
                                            public vpMbKltMultiTracker
{
protected:
...
protected:
  ...
  virtual unsigned int initMbtTracking(
      std::map<std::string, const vpImage<unsigned char> *> &mapOfImages,
      unsigned int lvl);
