...
/*!
  \file vpRobotJaco2.cpp
  \brief Interface for Kinova Jaco2 robot.
*/

#include <visp3/core/vpHomogeneousMatrix.h>
#include <visp3/robot/vpRobotJaco2.h>

/*!
  Basic initialization.
 */
void vpRobotJaco2::init()
{
...
*/
void vpRobotJaco2::get_eJe(vpMatrix &eJe)
{
  (void) eJe;
  std::cout << "Not implemented ! " << std::endl;
}
...
*/
void vpRobotJaco2::get_fJe(vpMatrix &fJe)
{
  (void) fJe;
  std::cout << "Not implemented ! " << std::endl;
}
 ...
 */
void vpRobotJaco2::setJointVelocity(const vpColVector &qdot)
{
  (void) qdot;
 ...
 */
void vpRobotJaco2::setVelocity(const vpRobot::vpControlFrameType frame, const vpColVector &vel)
{
 ...
 */
void vpRobotJaco2::getJointPosition(vpColVector &q)
{
  (void) q;
  std::cout << "Not implemented ! " << std::endl;
}
 ...
 */
void vpRobotJaco2::getPosition(const vpRobot::vpControlFrameType frame, vpColVector &q)
{
 ...
 */
void vpRobotJaco2::setPosition(const vpRobot::vpControlFrameType frame, const vpColVector &q)
{
  (void) frame;
  (void) q;
  std::cout << "Not implemented ! " << std::endl;
 ...
 */
void vpRobotJaco2::getDisplacement(const vpRobot::vpControlFrameType frame, vpColVector &q)
{
  (void) frame;
  (void) q;
  std::cout << "Not implemented ! " << std::endl;
...
// Work arround to avoid warning: libvisp_robot.a(vpRobotJaco2.cpp.o) has
// no symbols
void dummy_vpRobotJaco2(){};
#endif
