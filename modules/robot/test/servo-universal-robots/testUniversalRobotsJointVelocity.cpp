...
/*!
  \example testUniversalRobotsJointVelocity.cpp

  Test robot from Universal Robots joint velocity controller implemented in vpRobotUniversalRobots.
*/
...
int main(int argc, char **argv)
{
  ...
  try {
     ...
     */
    vpColVector dq_d(6, 0);
    dq_d[4] = vpMath::rad(-20.);
    dq_d[5] = vpMath::rad(20.);
