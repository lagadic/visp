...
TEST_CASE("Benchmark grayscale JPEG image loading - Solvay (640x440)", "[benchmark]")
{
...
TEST_CASE("Benchmark RGBA JPEG image loading - Solvay (640x440)", "[benchmark]")
{
  for (size_t j = 0; j < backends.size(); j++) {
...
TEST_CASE("Benchmark grayscale PNG image loading - Solvay (640x440)", "[benchmark]")
{
  for (size_t j = 0; j < backends.size(); j++) {
    vpImage<vpRGBa> I;
...
TEST_CASE("Benchmark RGBA PNG image loading - Solvay (640x440)", "[benchmark]")
{
  for (size_t j = 0; j < backends.size(); j++) {
    vpImage<unsigned char> I;
...
TEST_CASE("Benchmark grayscale JPEG image saving - Solvay (640x440)", "[benchmark]")
{
...
TEST_CASE("Benchmark RGBA JPEG image saving - Solvay (640x440)", "[benchmark]")
{
  std::string tmp_dir = vpIoTools::makeTempDirectory(vpIoTools::getTempPath());
  std::string directory_filename_tmp =
      tmp_dir + "/vpIoTools_perfImageLoadSave_" + vpTime::getDateTime("%Y-%m-%d_%H.%M.%S");
...
TEST_CASE("Benchmark grayscale PNG image saving - Solvay (640x440)", "[benchmark]")
{
  std::string tmp_dir = vpIoTools::makeTempDirectory(vpIoTools::getTempPath());
  std::string directory_filename_tmp =
      tmp_dir + "/vpIoTools_perfImageLoadSave_" + vpTime::getDateTime("%Y-%m-%d_%H.%M.%S");
...
TEST_CASE("Benchmark RGBA PNG image saving - Solvay (640x440)", "[benchmark]")
{
  std::string tmp_dir = vpIoTools::makeTempDirectory(vpIoTools::getTempPath());
  std::string directory_filename_tmp =
      tmp_dir + "/vpIoTools_perfImageLoadSave_" + vpTime::getDateTime("%Y-%m-%d_%H.%M.%S");
