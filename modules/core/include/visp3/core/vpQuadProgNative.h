...
/*!
 * \file vpQuadProgNative.h
 * \brief Implementation of Quadratic Program with Active Sets.
 */

#ifndef _vpQuadProgNative_h_
#define _vpQuadProgNative_h_
...
*/
class VISP_EXPORT vpQuadProgNative : public vpQuadProg
{
public:
  ...
  static void fromCanonicalCost(const vpMatrix &H, const vpColVector &g, vpMatrix &Q, vpColVector &r,
                                const double &tol = 1e-6);
  static bool solveQPe_static(const vpMatrix &Q, const vpColVector &r, vpMatrix A, vpColVector b, vpColVector &x,
                       const double &tol = 1e-6);
...
protected:
                                      ...
                                      const vpMatrix *C, const vpColVector *d, const std::string fct)
  {
    ...
    if ((Ab && n != A->getCols()) || (Cd && n != C->getCols()) || (Ab && A->getRows() != b->getRows()) ||
      ...
      std::cout << "vpQuadProgNative::" << fct << ": wrong dimension\n"
