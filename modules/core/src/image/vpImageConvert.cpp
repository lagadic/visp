...
uint16_t demosaicPhiBilinear(const uint16_t *bayer, unsigned int width, unsigned int i, unsigned int j)
{
  return static_cast<uint16_t>(0.5f*bayer[(i-1)*width + j] + 0.5f*bayer[(i+1)*width + j]);
}

uint16_t demosaicThetaBilinear(const uint16_t *bayer, unsigned int width, unsigned int i, unsigned int j)
{
  return static_cast<uint16_t>(0.5f*bayer[i*width + j - 1] + 0.5f*bayer[i*width + j + 1]);
}

uint16_t demosaicCheckerBilinear(const uint16_t *bayer, unsigned int width, unsigned int i, unsigned int j)
{
  return static_cast<uint16_t>(0.25f*bayer[(i-1)*width + j-1] + 0.25f*bayer[(i-1)*width + j+1] + 0.25f*bayer[(i+1)*width + j-1] + 0.25f*bayer[(i+1)*width + j+1]);
}

uint16_t demosaicCrossBilinear(const uint16_t *bayer, unsigned int width, unsigned int i, unsigned int j)
{
  return static_cast<uint16_t>(0.25f*bayer[(i-1)*width + j] + 0.25f*bayer[i*width + j-1] + 0.25f*bayer[i*width + j+1] + 0.25f*bayer[(i+1)*width + j]);
}

uint16_t demosaicPhiMalvar(const uint16_t *bayer, unsigned int width, unsigned int i, unsigned int j)
{
//  return static_cast<uint16_t>((-bayer[(i-2)*width + j] - bayer[(i-1)*width + j-1] + 4*bayer[(i-1)*width + j] - bayer[(i-1)*width + j+1] +
//      0.5f*bayer[i*width + j-2] + 5*bayer[i*width + j] + 0.5f*bayer[i*width + j+2] - bayer[(i+1)*width + j-1] + 4*bayer[(i+1)*width + j] -
//      bayer[(i+1)*width + j+1] - bayer[(i+2)*width + j]) / 8);

//  return vpMath::saturate<uint16_t>((-bayer[(i-2)*width + j] - bayer[(i-1)*width + j-1] + 4*bayer[(i-1)*width + j] - bayer[(i-1)*width + j+1] +
//      0.5f*bayer[i*width + j-2] + 5*bayer[i*width + j] + 0.5f*bayer[i*width + j+2] - bayer[(i+1)*width + j-1] + 4*bayer[(i+1)*width + j] -
//      bayer[(i+1)*width + j+1] - bayer[(i+2)*width + j]) / 8);

//  return vpMath::saturate<uint16_t>(-0.125f*bayer[(i-2)*width + j] - 0.125f*bayer[(i-1)*width + j-1] + 0.5f*bayer[(i-1)*width + j] - 0.125f*bayer[(i-1)*width + j+1] +
//      0.0625f*bayer[i*width + j-2] + 0.625f*bayer[i*width + j] + 0.0625f*bayer[i*width + j+2] - 0.125f*bayer[(i+1)*width + j-1] + 0.5f*bayer[(i+1)*width + j] -
//      0.125f*bayer[(i+1)*width + j+1] - 0.125f*bayer[(i+2)*width + j]);
...
uint16_t demosaicThetaMalvar(const uint16_t *bayer, unsigned int width, unsigned int i, unsigned int j)
{
//  return static_cast<uint16_t>((0.5f*bayer[(i-2)*width + j] - bayer[(i-1)*width + j-1] - bayer[(i-1)*width + j+1] - bayer[i*width + j-2] +
//      4*bayer[i*width + j-1] + 5*bayer[i*width + j] + 4*bayer[i*width + j+1] - bayer[i*width + j+2] - bayer[(i+1)*width + j-1] -
//      bayer[(i+1)*width + j+1] + 0.5f*bayer[(i+2)*width + j]) / 8);

//  return vpMath::saturate<uint16_t>((0.5f*bayer[(i-2)*width + j] - bayer[(i-1)*width + j-1] - bayer[(i-1)*width + j+1] - bayer[i*width + j-2] +
//      4*bayer[i*width + j-1] + 5*bayer[i*width + j] + 4*bayer[i*width + j+1] - bayer[i*width + j+2] - bayer[(i+1)*width + j-1] -
//      bayer[(i+1)*width + j+1] + 0.5f*bayer[(i+2)*width + j]) / 8);

//  return vpMath::saturate<uint16_t>(0.0625f*bayer[(i-2)*width + j] - 0.125f*bayer[(i-1)*width + j-1] - 0.125f*bayer[(i-1)*width + j+1] - 0.125f*bayer[i*width + j-2] +
//      0.5f*bayer[i*width + j-1] + 0.625f*bayer[i*width + j] + 0.5f*bayer[i*width + j+1] - 0.125f*bayer[i*width + j+2] - 0.125f*bayer[(i+1)*width + j-1] -
//      0.125f*bayer[(i+1)*width + j+1] + 0.0625f*bayer[(i+2)*width + j]);
...
uint16_t demosaicCheckerMalvar(const uint16_t *bayer, unsigned int width, unsigned int i, unsigned int j)
{
//  return static_cast<uint16_t>((-1.5f*bayer[(i-2)*width + j] + 2*bayer[(i-1)*width + j-1] + 2*bayer[(i-1)*width + j+1] -
//      1.5f*bayer[i*width + j-2] + 6*bayer[i*width + j] - 1.5f*bayer[i*width + j+2] + 2*bayer[(i+1)*width + j-1] +
//      2*bayer[(i+1)*width + j+1] - 1.5f*bayer[(i+2)*width + j]) / 8);

//  return vpMath::saturate<uint16_t>((-1.5f*bayer[(i-2)*width + j] + 2*bayer[(i-1)*width + j-1] + 2*bayer[(i-1)*width + j+1] -
//      1.5f*bayer[i*width + j-2] + 6*bayer[i*width + j] - 1.5f*bayer[i*width + j+2] + 2*bayer[(i+1)*width + j-1] +
//      2*bayer[(i+1)*width + j+1] - 1.5f*bayer[(i+2)*width + j]) / 8);

//  return vpMath::saturate<uint16_t>(-0.1875f*bayer[(i-2)*width + j] + 0.25f*bayer[(i-1)*width + j-1] + 0.25f*bayer[(i-1)*width + j+1] -
//      0.1875f*bayer[i*width + j-2] + 0.75f*bayer[i*width + j] - 0.1875f*bayer[i*width + j+2] + 0.25f*bayer[(i+1)*width + j-1] +
//      0.25f*bayer[(i+1)*width + j+1] - 0.1875f*bayer[(i+2)*width + j]);
...
uint16_t demosaicCrossMalvar(const uint16_t *bayer, unsigned int width, unsigned int i, unsigned int j)
{
//  return static_cast<uint16_t>((-bayer[(i-2)*width + j] + 2*bayer[(i-1)*width + j] - bayer[i*width + j-2] + 2*bayer[i*width + j-1] +
//      4*bayer[i*width + j] + 2*bayer[i*width + j+1] - bayer[i*width + j+2] + 2*bayer[(i+1)*width + j] - bayer[(i+2)*width + j]) / 8);

//  return vpMath::saturate<uint16_t>((-bayer[(i-2)*width + j] + 2*bayer[(i-1)*width + j] - bayer[i*width + j-2] + 2*bayer[i*width + j-1] +
//      4*bayer[i*width + j] + 2*bayer[i*width + j+1] - bayer[i*width + j+2] + 2*bayer[(i+1)*width + j] - bayer[(i+2)*width + j]) / 8);

//  return vpMath::saturate<uint16_t>(-0.125f*bayer[(i-2)*width + j] + 0.25f*bayer[(i-1)*width + j] - 0.125f*bayer[i*width + j-2] + 0.25f*bayer[i*width + j-1] +
//      0.5f*bayer[i*width + j] + 0.25f*bayer[i*width + j+1] - 0.125f*bayer[i*width + j+2] + 0.25f*bayer[(i+1)*width + j] - 0.125f*bayer[(i+2)*width + j]);
...
void vpImageConvert::demosaicGBRGToRGBaBilinear(const uint16_t *gbrg, uint16_t *rgba, unsigned int width, unsigned int height, unsigned int nThreads)
{
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      ...
      rgba[j*4 + 1] = gbrg[j];
      rgba[j*4 + 2] = static_cast<uint16_t>(0.5f*gbrg[j - 1] + 0.5f*gbrg[j + 1]);
    } else {
      rgba[j*4 + 0] = static_cast<uint16_t>(0.5f*gbrg[width + j - 1] + 0.5f*gbrg[width + j + 1]);
      rgba[j*4 + 1] = static_cast<uint16_t>(0.5f*gbrg[j - 1] + 0.5f*gbrg[j + 1]);
      rgba[j*4 + 2] = gbrg[j];
    }
  }
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      rgba[i*width*4 + 0] = static_cast<uint16_t>(0.5f*gbrg[(i-1)*width] + 0.5f*gbrg[(i+1)*width]);
      rgba[i*width*4 + 1] = gbrg[i*width];
      rgba[i*width*4 + 2] = gbrg[i*width + 1];
    } else {
      rgba[i*width*4 + 0] = gbrg[i*width];
      rgba[i*width*4 + 1] = static_cast<uint16_t>(0.5f*gbrg[(i-1)*width] + 0.5f*gbrg[(i+1)*width]);
      rgba[i*width*4 + 2] = static_cast<uint16_t>(0.5f*gbrg[(i-1)*width + 1] + 0.5f*gbrg[(i+1)*width + 1]);
    }
  }
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      rgba[(i*width*4 + width-1) + 0] = static_cast<uint16_t>(0.5f*gbrg[i*width - 2] + 0.5f*gbrg[(i+2)*width - 2]);
      ...
      rgba[(i*width*4 + width-1) + 2] = static_cast<uint16_t>(0.5f*gbrg[i*width - 1] + 0.5f*gbrg[(i+2)*width - 1]);
    }
  }
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      ...
      rgba[((height-1)*width + j)*4 + 1] = static_cast<uint16_t>(0.5f*gbrg[(height-1)*width + j - 1] + 0.5f*gbrg[(height-1)*width + j + 1]);
      rgba[((height-1)*width + j)*4 + 2] = static_cast<uint16_t>(0.5f*gbrg[(height-2)*width + j - 1] + 0.5f*gbrg[(height-2)*width + j + 1]);
    } else {
      rgba[((height-1)*width + j)*4 + 0] = static_cast<uint16_t>(0.5f*gbrg[(height-1)*width + j - 1] + 0.5f*gbrg[(height-1)*width + j + 1]);
...
void vpImageConvert::demosaicGBRGToRGBaMalvar(const uint16_t *gbrg, uint16_t *rgba, unsigned int width, unsigned int height, unsigned int nThreads)
{
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      rgba[j*4 + 0] = gbrg[width + j];
      rgba[j*4 + 1] = static_cast<uint16_t>(0.25f*gbrg[j] + 0.25f*gbrg[width + j - 1] + 0.25f*gbrg[width + j + 1] + 0.25f*gbrg[2*width + j]);
      rgba[j*4 + 2] = static_cast<uint16_t>(0.25f*gbrg[j - 1] + 0.25f*gbrg[j + 1] + 0.25f*gbrg[2*width + j - 1] + 0.25f*gbrg[2*width + j + 1]);
    } else {
      rgba[j*4 + 0] = static_cast<uint16_t>(0.5f*gbrg[width + j - 1] + 0.5f*gbrg[width + j + 1]);
      rgba[j*4 + 1] = gbrg[width + j];
      rgba[j*4 + 2] = static_cast<uint16_t>(0.5f*gbrg[j] + 0.5f*gbrg[2*width + j]);
    }
  }
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      rgba[i*width*4 + 0] = static_cast<uint16_t>(0.25f*gbrg[(i-1)*width] + 0.25f*gbrg[(i-1)*width + 2] + 0.25f*gbrg[(i+1)*width] + 0.5f*gbrg[(i+1)*width + 2]);
      rgba[i*width*4 + 1] = static_cast<uint16_t>(0.25f*gbrg[(i-1)*width + 1] + 0.25f*gbrg[i*width] + 0.25f*gbrg[i*width + 2] + 0.5f*gbrg[(i+1)*width + 1]);
      rgba[i*width*4 + 2] = gbrg[i*width + 1];
    } else {
      rgba[i*width*4 + 0] = static_cast<uint16_t>(0.5f*gbrg[i*width] + 0.5f*gbrg[i*width + 2]);
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      rgba[(i*width*4 + width-1) + 0] = static_cast<uint16_t>(0.5f*gbrg[i*width - 2] + 0.5f*gbrg[(i+2)*width - 2]);
      rgba[(i*width*4 + width-1) + 1] = gbrg[(i+1)*width - 2];
      rgba[(i*width*4 + width-1) + 2] = static_cast<uint16_t>(0.5f*gbrg[(i+1)*width - 3] + 0.5f*gbrg[(i+1)*width - 1]);
    } else {
      rgba[(i*width*4 + width-1) + 0] = gbrg[(i+1)*width - 2];
      rgba[(i*width*4 + width-1) + 1] = static_cast<uint16_t>(0.25f*gbrg[i*width - 2] + 0.25f*gbrg[(i+1)*width - 3] +
          0.25f*gbrg[(i+1)*width - 1] + 0.25f*gbrg[(i+2)*width - 2]);
      rgba[(i*width*4 + width-1) + 2] = static_cast<uint16_t>(0.25f*gbrg[i*width - 3] + 0.25f*gbrg[i*width - 1] +
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      rgba[((height-1)*width + j)*4 + 0] = static_cast<uint16_t>(0.5f*gbrg[(height-3)*width + j] + 0.5f*gbrg[(height-1)*width + j]);
      rgba[((height-1)*width + j)*4 + 1] = gbrg[(height-2)*width + j];
      rgba[((height-1)*width + j)*4 + 2] = static_cast<uint16_t>(0.5f*gbrg[(height-2)*width + j - 1] + 0.5f*gbrg[(height-2)*width + j + 1]);
    } else {
      rgba[((height-1)*width + j)*4 + 0] = static_cast<uint16_t>(0.25f*gbrg[(height-3)*width + j - 1] + 0.25f*gbrg[(height-3)*width + j + 1] +
          0.25f*gbrg[(height-1)*width + j - 1] + 0.25f*gbrg[(height-1)*width + j + 1]);
      rgba[((height-1)*width + j)*4 + 1] = static_cast<uint16_t>(0.25f*gbrg[(height-3)*width + j] + 0.25f*gbrg[(height-2)*width + j - 1] +
...
//  #pragma omp parallel for schedule(dynamic)
//#endif
//  for (unsigned int by = 2; by < height-2-8; by += 8) {
//    for (unsigned int bx = 2; bx < width-2-8; bx += 8) {
...
//  #pragma omp parallel for schedule(dynamic)
//#endif
//  for (unsigned int i = 2; i < height-2; i+=2) {
//    for (unsigned int j = 2; j < width-2; j+=2) {
//      rgba[(i*width + j) * 4 + 0] = demosaicPhiMalvar(gbrg, width, i, j);
//      rgba[(i*width + j) * 4 + 1] = gbrg[i*width + j];
//      rgba[(i*width + j) * 4 + 2] = demosaicThetaMalvar(gbrg, width, i, j);

//      rgba[(i*width + j+1) * 4 + 0] = demosaicCheckerMalvar(gbrg, width, i, j+1);
//      rgba[(i*width + j+1) * 4 + 1] = demosaicCrossMalvar(gbrg, width, i, j+1);
//      rgba[(i*width + j+1) * 4 + 2] = gbrg[i*width + j+1];
//    }

//    for (unsigned int j = 2; j < width-2; j+=2) {
//      rgba[((i+1)*width + j) * 4 + 0] = gbrg[(i+1)*width + j];
//      rgba[((i+1)*width + j) * 4 + 1] = demosaicCrossMalvar(gbrg, width, i+1, j);
//      rgba[((i+1)*width + j) * 4 + 2] = demosaicCheckerMalvar(gbrg, width, i+1, j);

//      rgba[((i+1)*width + j+1) * 4 + 0] = demosaicThetaMalvar(gbrg, width, i+1, j+1);
//      rgba[((i+1)*width + j+1) * 4 + 1] = gbrg[(i+1)*width + j+1];
//      rgba[((i+1)*width + j+1) * 4 + 2] = demosaicPhiMalvar(gbrg, width, i+1, j+1);
//    }
//  }
}
...
void vpImageConvert::demosaicGRBGToRGBaBilinear(const uint16_t *grbg, uint16_t *rgba, unsigned int width, unsigned int height, unsigned int nThreads)
{
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      rgba[j*4 + 0] = static_cast<uint16_t>(0.5f*grbg[j - 1] + 0.5f*grbg[j + 1]);
      rgba[j*4 + 1] = grbg[j];
      rgba[j*4 + 2] = grbg[width + j];
    } else {
      rgba[j*4 + 0] = grbg[j];
      rgba[j*4 + 1] = static_cast<uint16_t>(0.5f*grbg[j - 1] + 0.5f*grbg[j + 1]);
      rgba[j*4 + 2] = static_cast<uint16_t>(0.5f*grbg[width + j - 1] + 0.5f*grbg[width + j + 1]);
    }
  }
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      ...
      rgba[i*width*4 + 2] = static_cast<uint16_t>(0.5f*grbg[(i-1)*width] + 0.5f*grbg[(i+1)*width]);
    } else {
      rgba[i*width*4 + 0] = static_cast<uint16_t>(0.5f*grbg[(i-1)*width + 1] + 0.5f*grbg[(i+1)*width + 1]);
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      ...
      rgba[(i*width*4 + width-1) + 2] = static_cast<uint16_t>(0.5f*grbg[i*width - 2] + 0.5f*grbg[(i+2)*width - 2]);
    } else {
      rgba[(i*width*4 + width-1) + 0] = static_cast<uint16_t>(0.5f*grbg[i*width - 1] + 0.5f*grbg[(i+2)*width - 1]);
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      rgba[((height-1)*width + j)*4 + 0] = static_cast<uint16_t>(0.5f*grbg[(height-2)*width + j - 1] + 0.5f*grbg[(height-2)*width + j + 1]);
      rgba[((height-1)*width + j)*4 + 1] = static_cast<uint16_t>(0.5f*grbg[(height-1)*width + j - 1] + 0.5f*grbg[(height-1)*width + j + 1]);
      ...
      rgba[((height-1)*width + j)*4 + 2] = static_cast<uint16_t>(0.5f*grbg[(height-1)*width + j - 1] + 0.5f*grbg[(height-1)*width + j + 1]);
    }
  }
...
void vpImageConvert::demosaicGRBGToRGBaMalvar(const uint16_t *grbg, uint16_t *rgba, unsigned int width, unsigned int height, unsigned int nThreads)
{
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      rgba[j*4 + 0] = static_cast<uint16_t>(0.25f*grbg[j - 1] + 0.25f*grbg[j + 1] + 0.25f*grbg[2*width + j - 1] + 0.25f*grbg[2*width + j + 1]);
      rgba[j*4 + 1] = static_cast<uint16_t>(0.25f*grbg[j] + 0.25f*grbg[width + j - 1] + 0.25f*grbg[width + j + 1] + 0.25f*grbg[2*width + j]);
      rgba[j*4 + 2] = grbg[width + j];
    } else {
      rgba[j*4 + 0] = static_cast<uint16_t>(0.5f*grbg[j] + 0.5f*grbg[2*width + j]);
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      rgba[i*width*4 + 0] = grbg[i*width + 1];
      rgba[i*width*4 + 1] = static_cast<uint16_t>(0.25f*grbg[(i-1)*width + 1] + 0.25f*grbg[i*width] + 0.25f*grbg[i*width + 2] + 0.25f*grbg[(i+1)*width + 1]);
      rgba[i*width*4 + 2] = static_cast<uint16_t>(0.25f*grbg[(i-1)*width] + 0.25f*grbg[(i-1)*width + 2] + 0.25f*grbg[(i+1)*width] + 0.25f*grbg[(i+1)*width + 2]);
    } else {
      rgba[i*width*4 + 0] = static_cast<uint16_t>(0.5f*grbg[(i-1)*width + 1] + 0.5f*grbg[(i+1)*width + 1]);
      rgba[i*width*4 + 1] = grbg[i*width + 1];
      rgba[i*width*4 + 2] = static_cast<uint16_t>(0.5f*grbg[i*width] + 0.5f*grbg[i*width + 2]);
    }
  }
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      rgba[(i*width*4 + width-1) + 0] = static_cast<uint16_t>(0.5f*grbg[(i+1)*width - 3] + 0.5f*grbg[(i+1)*width - 1]);
      rgba[(i*width*4 + width-1) + 1] = grbg[(i+1)*width - 2];
      rgba[(i*width*4 + width-1) + 2] = static_cast<uint16_t>(0.5f*grbg[i*width - 2] + 0.5f*grbg[(i+2)*width - 2]);
    } else {
      rgba[(i*width*4 + width-1) + 0] = static_cast<uint16_t>(0.25f*grbg[i*width - 3] + 0.25f*grbg[i*width - 1] + 0.25f*grbg[(i+2)*width - 3] + 0.25f*grbg[(i+2)*width - 1]);
      rgba[(i*width*4 + width-1) + 1] = static_cast<uint16_t>(0.25f*grbg[i*width - 2] + 0.25f*grbg[(i+1)*width - 3] + 0.25f*grbg[(i+1)*width - 1] + 0.25f*grbg[(i+2)*width - 2]);
      rgba[(i*width*4 + width-1) + 2] = grbg[(i+1)*width - 2];
    }
  }
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      ...
      rgba[((height-1)*width + j)*4 + 2] = static_cast<uint16_t>(0.5f*grbg[(height-3)*width + j] + 0.5f*grbg[(height-1)*width + j]);
    } else {
      rgba[((height-1)*width + j)*4 + 0] = grbg[(height-2)*width + j];
      rgba[((height-1)*width + j)*4 + 1] = static_cast<uint16_t>(0.25f*grbg[(height-3)*width + j] + 0.25f*grbg[(height-2)*width + j - 1] +
          0.25f*grbg[(height-2)*width + j + 1] + 0.25f*grbg[(height-1)*width + j]);
      rgba[((height-1)*width + j)*4 + 2] = static_cast<uint16_t>(0.25f*grbg[(height-3)*width + j - 1] + 0.25f*grbg[(height-3)*width + j + 1] +
...
void vpImageConvert::demosaicBGGRToRGBaBilinear(const uint16_t *bggr, uint16_t *rgba, unsigned int width, unsigned int height, unsigned int nThreads)
{
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      rgba[j*4 + 0] = static_cast<uint16_t>(0.5f*bggr[width + j - 1] + 0.5f*bggr[width + j + 1]);
      rgba[j*4 + 1] = static_cast<uint16_t>(0.5f*bggr[j - 1] + 0.5f*bggr[j + 1]);
      rgba[j*4 + 2] = bggr[j];
    } else {
      rgba[j*4 + 0] = bggr[width + j];
      rgba[j*4 + 1] = bggr[j];
      rgba[j*4 + 2] = static_cast<uint16_t>(0.5f*bggr[j - 1] + 0.5f*bggr[j + 1]);
    }
  }
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      rgba[i*width*4 + 0] = static_cast<uint16_t>(0.5f*bggr[(i-1)*width + 1] + 0.5f*bggr[(i+1)*width + 1]);
      rgba[i*width*4 + 1] = bggr[i*width + 1];
      rgba[i*width*4 + 2] = bggr[i*width];
    } else {
      rgba[i*width*4 + 0] = bggr[i*width + 1];
      rgba[i*width*4 + 1] = bggr[i*width];
      rgba[i*width*4 + 2] = static_cast<uint16_t>(0.5f*bggr[(i-1)*width] + 0.5f*bggr[(i+1)*width]);
    }
  }
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      rgba[(i*width*4 + width-1) + 0] = static_cast<uint16_t>(0.5f*bggr[i*width - 1] + 0.5f*bggr[(i+2)*width - 1]);
      ...
      rgba[(i*width*4 + width-1) + 2] = static_cast<uint16_t>(0.5f*bggr[i*width - 2] + 0.5f*bggr[(i+2)*width - 2]);
    }
  }
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      rgba[((height-1)*width + j)*4 + 0] = static_cast<uint16_t>(0.5f*bggr[(height-1)*width + j - 1] + 0.5f*bggr[(height-1)*width + j + 1]);
      ...
      rgba[((height-1)*width + j)*4 + 1] = static_cast<uint16_t>(0.5f*bggr[(height-1)*width + j - 1] + 0.5f*bggr[(height-1)*width + j + 1]);
      rgba[((height-1)*width + j)*4 + 2] = static_cast<uint16_t>(0.5f*bggr[(height-2)*width + j - 1] + 0.5f*bggr[(height-2)*width + j + 1]);
    }
  }
...
void vpImageConvert::demosaicBGGRToRGBaMalvar(const uint16_t *bggr, uint16_t *rgba, unsigned int width, unsigned int height, unsigned int nThreads)
{
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      ...
      rgba[j*4 + 2] = static_cast<uint16_t>(0.5f*bggr[j] + 0.5f*bggr[2*width + j]);
    } else {
      rgba[j*4 + 0] = bggr[width + j];
      rgba[j*4 + 1] = static_cast<uint16_t>(0.25f*bggr[j] + 0.25f*bggr[width + j - 1] + 0.25f*bggr[width + j + 1] + 0.25f*bggr[2*width + j]);
      rgba[j*4 + 2] = static_cast<uint16_t>(0.25f*bggr[j - 1] + 0.25f*bggr[j + 1] + 0.25f*bggr[2*width + j - 1] + 0.25f*bggr[2*width + j + 1]);
    }
  }
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      rgba[i*width*4 + 0] = static_cast<uint16_t>(0.5f*bggr[(i-1)*width + 1] + 0.5f*bggr[(i+1)*width + 1]);
      rgba[i*width*4 + 1] = bggr[i*width + 1];
      rgba[i*width*4 + 2] = static_cast<uint16_t>(0.5f*bggr[i*width] + 0.5f*bggr[i*width + 2]);
    } else {
      rgba[i*width*4 + 0] = bggr[i*width + 1];
      rgba[i*width*4 + 1] = static_cast<uint16_t>(0.25f*bggr[(i-1)*width + 1] + 0.25f*bggr[i*width] + 0.25f*bggr[i*width + 2] + 0.25f*bggr[(i+1)*width + 1]);
      rgba[i*width*4 + 2] = static_cast<uint16_t>(0.25f*bggr[(i-1)*width] + 0.25f*bggr[(i-1)*width + 2] + 0.25f*bggr[(i+1)*width] + 0.25f*bggr[(i+1)*width + 2]);
    }
  }
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      rgba[(i*width*4 + width-1) + 0] = static_cast<uint16_t>(0.25f*bggr[i*width - 3] + 0.25f*bggr[i*width - 1] + 0.25f*bggr[(i+2)*width - 3] + 0.25f*bggr[(i+2)*width - 1]);
      rgba[(i*width*4 + width-1) + 1] = static_cast<uint16_t>(0.25f*bggr[i*width - 2] + 0.25f*bggr[(i+1)*width - 3] +
          0.25f*bggr[(i+1)*width - 1] + 0.25f*bggr[(i+2)*width - 2]);
      rgba[(i*width*4 + width-1) + 2] = bggr[(i+1)*width - 2];
    } else {
      rgba[(i*width*4 + width-1) + 0] = static_cast<uint16_t>(0.5f*bggr[(i+1)*width - 3] + 0.5f*bggr[(i+1)*width - 1]);
      rgba[(i*width*4 + width-1) + 1] = bggr[(i+1)*width - 2];
      rgba[(i*width*4 + width-1) + 2] = static_cast<uint16_t>(0.5f*bggr[i*width - 2] + 0.5f*bggr[(i+2)*width - 2]);
    }
  }
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      rgba[((height-1)*width + j)*4 + 0] = static_cast<uint16_t>(0.25f*bggr[(height-3)*width + j - 1] + 0.25f*bggr[(height-3)*width + j + 1] +
          0.25f*bggr[(height-1)*width + j - 1] + 0.25f*bggr[(height-1)*width + j + 1]);
      rgba[((height-1)*width + j)*4 + 1] = static_cast<uint16_t>(0.5f*bggr[(height-2)*width + j - 1] + 0.5f*bggr[(height-2)*width + j + 1]);
      rgba[((height-1)*width + j)*4 + 2] = bggr[(height-2)*width + j];
    } else {
      rgba[((height-1)*width + j)*4 + 0] = static_cast<uint16_t>(0.5f*bggr[(height-3)*width + j] + 0.5f*bggr[(height-1)*width + j]);
...
void vpImageConvert::demosaicRGGBToRGBaBilinear(const uint16_t *rggb, uint16_t *rgba, unsigned int width, unsigned int height, unsigned int nThreads)
{
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      rgba[j*4 + 0] = rggb[j];
      rgba[j*4 + 1] = static_cast<uint16_t>(0.5f*rggb[j - 1] + 0.5f*rggb[j + 1]);
      rgba[j*4 + 2] = static_cast<uint16_t>(0.5f*rggb[width + j - 1] + 0.5f*rggb[width + j + 1]);
    } else {
      rgba[j*4 + 0] = static_cast<uint16_t>(0.5f*rggb[j - 1] + 0.5f*rggb[j + 1]);
      rgba[j*4 + 1] = rggb[j];
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      ...
      rgba[i*width*4 + 2] = static_cast<uint16_t>(0.5f*rggb[(i-1)*width + 1] + 0.5f*rggb[(i+1)*width + 1]);
    } else {
      rgba[i*width*4 + 0] = static_cast<uint16_t>(0.5f*rggb[(i-1)*width] + 0.5f*rggb[(i+1)*width]);
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      ...
      rgba[(i*width*4 + width-1) + 2] = static_cast<uint16_t>(0.5f*rggb[i*width - 1] + 0.5f*rggb[(i+2)*width - 1]);
    } else {
      rgba[(i*width*4 + width-1) + 0] = static_cast<uint16_t>(0.5f*rggb[i*width - 2] + 0.5f*rggb[(i+2)*width - 2]);
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      ...
      rgba[((height-1)*width + j)*4 + 2] = static_cast<uint16_t>(0.5f*rggb[(height-1)*width + j - 1] + 0.5f*rggb[(height-1)*width + j + 1]);
    } else {
      rgba[((height-1)*width + j)*4 + 0] = static_cast<uint16_t>(0.5f*rggb[(height-2)*width + j - 1] + 0.5f*rggb[(height-2)*width + j + 1]);
      rgba[((height-1)*width + j)*4 + 1] = static_cast<uint16_t>(0.5f*rggb[(height-1)*width + j - 1] + 0.5f*rggb[(height-1)*width + j + 1]);
...
void vpImageConvert::demosaicRGGBToRGBaMalvar(const uint16_t *rggb, uint16_t *rgba, unsigned int width, unsigned int height, unsigned int nThreads)
{
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      rgba[j*4 + 0] = static_cast<uint16_t>(0.5f*rggb[j] + 0.5f*rggb[2*width + j]);
      rgba[j*4 + 1] = rggb[width + j];
      rgba[j*4 + 2] = static_cast<uint16_t>(0.5f*rggb[width + j - 1] + 0.5f*rggb[width + j + 1]);
    } else {
      rgba[j*4 + 0] = static_cast<uint16_t>(0.25f*rggb[j - 1] + 0.25f*rggb[j + 1] + 0.25f*rggb[2*width + j - 1] + 0.25f*rggb[2*width + j + 1]);
      rgba[j*4 + 1] = static_cast<uint16_t>(0.25f*rggb[j] + 0.25f*rggb[width + j - 1] + 0.25f*rggb[width + j + 1] + 0.25f*rggb[2*width + j]);
      rgba[j*4 + 2] = rggb[width + j];
    }
  }
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      rgba[i*width*4 + 0] = static_cast<uint16_t>(0.5f*rggb[i*width] + 0.5f*rggb[i*width + 2]);
      rgba[i*width*4 + 1] = rggb[i*width + 1];
      rgba[i*width*4 + 2] = static_cast<uint16_t>(0.5f*rggb[(i-1)*width + 1] + 0.5f*rggb[(i+1)*width + 1]);
    } else {
      rgba[i*width*4 + 0] = static_cast<uint16_t>(0.25f*rggb[(i-1)*width] + 0.25f*rggb[(i-1)*width + 2] + 0.25f*rggb[(i+1)*width] + 0.25f*rggb[(i+1)*width + 2]);
      rgba[i*width*4 + 1] = static_cast<uint16_t>(0.25f*rggb[(i-1)*width + 1] + 0.25f*rggb[i*width] + 0.25f*rggb[i*width + 2] + 0.25f*rggb[(i+1)*width + 1]);
      rgba[i*width*4 + 2] = rggb[i*width + 1];
    }
  }
  ...
  for (unsigned int i = 1; i < height-1; i++) {
    if (i % 2 == 0) {
      rgba[(i*width*4 + width-1) + 0] = rggb[(i+1)*width - 2];
      rgba[(i*width*4 + width-1) + 1] = static_cast<uint16_t>(0.25f*rggb[i*width - 2] + 0.25f*rggb[(i+1)*width - 3] + 0.25f*rggb[(i+1)*width - 1] + 0.25f*rggb[(i+2)*width - 2]);
      rgba[(i*width*4 + width-1) + 2] = static_cast<uint16_t>(0.25f*rggb[i*width - 3] + 0.25f*rggb[i*width - 1] + 0.25f*rggb[(i+2)*width - 3] + 0.25f*rggb[(i+2)*width - 1]);
    } else {
      rgba[(i*width*4 + width-1) + 0] = static_cast<uint16_t>(0.5f*rggb[i*width - 2] + 0.5f*rggb[(i+2)*width - 2]);
      rgba[(i*width*4 + width-1) + 1] = rggb[(i+1)*width - 2];
      rgba[(i*width*4 + width-1) + 2] = static_cast<uint16_t>(0.5f*rggb[(i+1)*width - 3] + 0.5f*rggb[(i+1)*width - 1]);
    }
  }
  ...
  for (unsigned int j = 1; j < width-1; j++) {
    if (j % 2 == 0) {
      rgba[((height-1)*width + j)*4 + 0] = rggb[(height-2)*width + j];
      rgba[((height-1)*width + j)*4 + 1] = static_cast<uint16_t>(0.25f*rggb[(height-3)*width + j] + 0.25f*rggb[(height-2)*width + j - 1] +
          0.25f*rggb[(height-2)*width + j + 1] + 0.25f*rggb[(height-1)*width + j]);
      rgba[((height-1)*width + j)*4 + 2] = static_cast<uint16_t>(0.25f*rggb[(height-3)*width + j - 1] + 0.25f*rggb[(height-3)*width + j + 1] +
          0.25f*rggb[(height-1)*width + j - 1] + 0.25f*rggb[(height-1)*width + j + 1]);
    } else {
      rgba[((height-1)*width + j)*4 + 0] = static_cast<uint16_t>(0.5f*rggb[(height-2)*width + j - 1] + 0.5f*rggb[(height-2)*width + j + 1]);
      rgba[((height-1)*width + j)*4 + 1] = rggb[(height-2)*width + j];
      rgba[((height-1)*width + j)*4 + 2] = static_cast<uint16_t>(0.5f*rggb[(height-3)*width + j] + 0.5f*rggb[(height-1)*width + j]);
    }
  }
