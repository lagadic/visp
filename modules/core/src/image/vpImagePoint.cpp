...
*/
VISP_EXPORT bool operator==(const VISP_NAMESPACE_ADDRESSING vpImagePoint &ip1, const VISP_NAMESPACE_ADDRESSING vpImagePoint &ip2)
{
...
*/
VISP_EXPORT VISP_NAMESPACE_ADDRESSING vpImagePoint operator+(const VISP_NAMESPACE_ADDRESSING vpImagePoint &ip1, const VISP_NAMESPACE_ADDRESSING vpImagePoint &ip2)
{
  return (VISP_NAMESPACE_ADDRESSING vpImagePoint(ip1.get_i() + ip2.get_i(), ip1.get_j() + ip2.get_j()));
}
...
int main()
{
  ...
  \endcode
*/
VISP_EXPORT VISP_NAMESPACE_ADDRESSING vpImagePoint operator+(const VISP_NAMESPACE_ADDRESSING vpImagePoint &ip1, int offset)
{
  return (VISP_NAMESPACE_ADDRESSING vpImagePoint(ip1.get_i() + offset, ip1.get_j() + offset));
}
...
int main()
{
  ...
  \endcode
*/
VISP_EXPORT VISP_NAMESPACE_ADDRESSING vpImagePoint operator+(const VISP_NAMESPACE_ADDRESSING vpImagePoint &ip1, unsigned int offset)
{
  return (VISP_NAMESPACE_ADDRESSING vpImagePoint(ip1.get_i() + offset, ip1.get_j() + offset));
}
...
int main()
{
  ...
  \endcode
*/
VISP_EXPORT VISP_NAMESPACE_ADDRESSING vpImagePoint operator+(const VISP_NAMESPACE_ADDRESSING vpImagePoint &ip1, double offset)
{
  return (VISP_NAMESPACE_ADDRESSING vpImagePoint(ip1.get_i() + offset, ip1.get_j() + offset));
}
...
int main()
{
  ...
  \endcode
*/
VISP_EXPORT VISP_NAMESPACE_ADDRESSING vpImagePoint operator*(const VISP_NAMESPACE_ADDRESSING vpImagePoint &ip1, double scale)
{
  return (VISP_NAMESPACE_ADDRESSING vpImagePoint(ip1.get_i() * scale, ip1.get_j() * scale));
}
...
Image point with coordinates: 10, 11.1
  \endverbatim
*/
VISP_EXPORT std::ostream &operator<<(std::ostream &os, const VISP_NAMESPACE_ADDRESSING vpImagePoint &ip)
{
