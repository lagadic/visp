...
{
  (void)depth_scale;
  return static_cast<double>(data[static_cast<int>(offset)]);
}

double getDepth(const uint16_t *data, const std::optional<double> depth_scale, const double &offset)
{
  return *depth_scale * static_cast<double>(data[static_cast<int>(offset)]);
}
...
vpImagePoint project_color_to_depth(
  const Type *data, std::optional<double> depth_scale, const double &depth_min, const double &depth_max, const double &depth_width,
  ...
  const vpHomogeneousMatrix &color_M_depth, const vpHomogeneousMatrix &depth_M_color, const vpImagePoint &from_pixel)
{
  ...
  for (auto curr_pixel = start_pixel; curr_pixel.inSegment(start_pixel, end_pixel) && (curr_pixel != end_pixel);
    ...
    const auto depth = getDepth(data, depth_scale, (curr_pixel.get_v() * depth_width) + curr_pixel.get_u());
...
#else
double getDepth(const float *data, const double *depth_scale, const double &offset)
{
  (void)depth_scale;
  return static_cast<double>(data[static_cast<int>(offset)]);
}

double getDepth(const uint16_t *data, const double *depth_scale, const double &offset)
{
  return *depth_scale * static_cast<double>(data[static_cast<int>(offset)]);
}
...
template<typename Type>
vpImagePoint project_color_to_depth(
  const Type *data, const double *depth_scale, const double &depth_min, const double &depth_max, const double &depth_width,
  const double &depth_height, const vpCameraParameters &depth_intrinsics, const vpCameraParameters &color_intrinsics,
  const vpHomogeneousMatrix &color_M_depth, const vpHomogeneousMatrix &depth_M_color, const vpImagePoint &from_pixel)
{
  vpImagePoint depth_pixel;
  ...
  for (vpImagePoint curr_pixel = start_pixel; curr_pixel.inSegment(start_pixel, end_pixel) && curr_pixel != end_pixel;
       curr_pixel = curr_pixel.nextInSegment(start_pixel, end_pixel)) {
    const double depth = getDepth(data, depth_scale, (curr_pixel.get_v() * depth_width) + curr_pixel.get_u());
...
vpImagePoint vpColorDepthConversion::projectColorToDepth(
  const vpImage<uint16_t> &I_depth, const double &depth_scale, const double &depth_min, const double &depth_max,
 ...
 */
vpImagePoint vpColorDepthConversion::projectColorToDepth(
  const uint16_t *data, const double &depth_scale, const double &depth_min, const double &depth_max, const double &depth_width,
  const double &depth_height, const vpCameraParameters &depth_intrinsics, const vpCameraParameters &color_intrinsics,
  const vpHomogeneousMatrix &color_M_depth, const vpHomogeneousMatrix &depth_M_color, const vpImagePoint &from_pixel)
{
#if (VISP_CXX_STANDARD > VISP_CXX_STANDARD_98)
...
#else
  return project_color_to_depth(data, &depth_scale, depth_min, depth_max, depth_width, depth_height,
                             depth_intrinsics, color_intrinsics, color_M_depth, depth_M_color, from_pixel);
#endif
}
 ...
 * Project color image point to depth frame.
 *
 * \param[in] I_depth : Depth map image.
 * \param[in] depth_min : Minimal depth value for correspondence [m].
 * \param[in] depth_max : Maximal depth value for correspondence [m].
 * \param[in] depth_intrinsics : Intrinsic depth camera parameters.
 * \param[in] color_intrinsics : Intrinsic color camera parameters.
 ...
 */
vpImagePoint vpColorDepthConversion::projectColorToDepth(
  const vpImage<float> &I_depth, const double &depth_min, const double &depth_max,
  const vpCameraParameters &depth_intrinsics, const vpCameraParameters &color_intrinsics,
  const vpHomogeneousMatrix &color_M_depth, const vpHomogeneousMatrix &depth_M_color, const vpImagePoint &from_pixel)
{
#if (VISP_CXX_STANDARD > VISP_CXX_STANDARD_98)
 ...
 */
vpImagePoint vpColorDepthConversion::projectColorToDepth(
  const float *data, const double &depth_min, const double &depth_max, const double &depth_width,
  const double &depth_height, const vpCameraParameters &depth_intrinsics, const vpCameraParameters &color_intrinsics,
  const vpHomogeneousMatrix &color_M_depth, const vpHomogeneousMatrix &depth_M_color, const vpImagePoint &from_pixel)
{
#if (VISP_CXX_STANDARD > VISP_CXX_STANDARD_98)
...
#else
  return project_color_to_depth(data, nullptr, depth_min, depth_max, depth_width, depth_height,
                             depth_intrinsics, color_intrinsics, color_M_depth, depth_M_color, from_pixel);
#endif
}
END_VISP_NAMESPACE
