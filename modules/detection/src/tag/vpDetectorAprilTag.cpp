...
vpDetectorAprilTag::vpDetectorAprilTag(const vpAprilTagFamily &tagFamily,
  ...
  : m_displayTag(false), m_displayTagColor(vpColor::none), m_displayTagThickness(2),
    m_poseEstimationMethod(poseEstimationMethod), m_tagFamily(tagFamily), m_point3d(), m_defaultCam(),
...
vpDetectorAprilTag::vpDetectorAprilTag(const vpDetectorAprilTag &o)
  : vpDetectorBase (o),
    m_displayTag(false), m_displayTagColor(vpColor::none), m_displayTagThickness(2),
    m_poseEstimationMethod(o.m_poseEstimationMethod), m_tagFamily(o.m_tagFamily), m_point3d(), m_defaultCam(),
 ...
 */
std::vector<std::vector<vpPoint> > vpDetectorAprilTag::getPoint3D() const
{
  return m_point3d;
}
