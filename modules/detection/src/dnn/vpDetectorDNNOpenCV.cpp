...
void from_json(const nlohmann::json &j, VISP_NAMESPACE_ADDRESSING vpDetectorDNNOpenCV::NetConfig &config);
void to_json(nlohmann::json &j, const VISP_NAMESPACE_ADDRESSING vpDetectorDNNOpenCV::NetConfig &config);
std::ostream &operator<<(std::ostream &os, const VISP_NAMESPACE_ADDRESSING vpDetectorDNNOpenCV::NetConfig &config);

class VISP_NAMESPACE_ADDRESSING vpDetectorDNNOpenCV::NetConfig
{
private:
...
void from_json(const nlohmann::json &j, VISP_NAMESPACE_ADDRESSING vpDetectorDNNOpenCV::NetConfig &config)
{
  ...
  config.m_parsingMethodType = VISP_NAMESPACE_ADDRESSING vpDetectorDNNOpenCV::dnnResultsParsingTypeFromString(j.value("parsingType", dnnResultsParsingTypeToString(config.m_parsingMethodType)));
...
void to_json(nlohmann::json &j, const VISP_NAMESPACE_ADDRESSING vpDetectorDNNOpenCV::NetConfig &config)
{
  ...
  j = nlohmann::json {
    ...
    {"parsingType"    , VISP_NAMESPACE_ADDRESSING vpDetectorDNNOpenCV::dnnResultsParsingTypeToString(config.m_parsingMethodType) },
