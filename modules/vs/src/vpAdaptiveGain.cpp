...
/*!
  ...
  - \f$ \lambda_\infty = 0.1666 \f$ using vpAdaptiveGain::DEFAULT_LAMBDA_INFINITY
...
/*!
  Constructor that initializes the gain as constant. In that case \f$\lambda(||{\bf e}||) = c\f$.
...
/*!
  ...
  \param gain_at_zero : the expected gain when \f$||{\bf e}||=0\f$: \f$\lambda_0\f$.
  \param gain_at_infinity : the expected gain when \f$||{\bf e}||\rightarrow\infty\f$: \f$\lambda_\infty\f$.
  \param slope_at_zero : the expected slope of \f$\lambda(||{\bf e}||)\f$ when \f$||{\bf e}||=0\f$: \f$\lambda'_0\f$.
...
/*!
  Initializes the parameters to have a constant gain. In that case \f$\lambda(||{\bf e}||) = c\f$.
...
/*!
  Set the parameters \f$\lambda_0, \lambda_\infty, \lambda'_0\f$ used to compute \f$\lambda(||{\bf e}||)\f$.
...
/*!
  ...
  norm \f$||{\bf e}||\f$ or the infinity norm \f$||{\bf e}||_{\infty}\f$ of the task function.
...
/*!
  Gets the value of the gain at infinity (ie the value of \f$ \lambda_\infty = c \f$).
...
/*!
  Gets the value of the gain at infinity (ie the value of \f$\lambda_\infty = c \f$) and stores it
...
/*!
  ...
  \f[ \lambda ({||x||}_{\infty}) = (\lambda_0 - \lambda_\infty) e^{ -\frac{ \lambda'_0}{\lambda_0 - \lambda_\infty}{||x||}_{\infty}} + \lambda_\infty \f]
...
/*!
  Prints the adaptive gain parameters \f$\lambda_0, \lambda_\infty, \lambda'_0\f$.
