...
import org.visp.test.ViSPTestRunner;
...
public class UtilsTest extends ViSPTestCase {
    ...
    public void testBitmapToMat() {
        ...
        Bitmap bmp16 = BitmapFactory.decodeFile(ViSPTestRunner.LENA_PATH, opt16);
        Mat m16 = new Mat();
        ...
        Bitmap bmp32 = BitmapFactory.decodeFile(ViSPTestRunner.LENA_PATH, opt32);*/
    ...
    public void testMatToBitmap() {
        Mat imgBGR = Imgcodecs.imread( ViSPTestRunner.LENA_PATH );
