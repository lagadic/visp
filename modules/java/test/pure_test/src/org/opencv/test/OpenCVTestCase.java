...
import org.visp.core.Point3;
import org.visp.core.Rect;
import org.visp.core.Scalar;
import org.visp.core.Size;
import org.visp.core.DMatch;
import org.visp.core.KeyPoint;
import org.visp.imgcodecs.Imgcodecs;

public class ViSPTestCase extends TestCase {
    ...
    protected static final String XFEATURES2D = "org.visp.xfeatures2d.";
    ...
    private static final String TAG = "ViSPTestCase";
    ...
    // TODO: ViSPTestCase refactorings
    // - rename matrices
    ...
    protected void setUp() throws Exception {
        ...
        ViSPTestRunner.LENA_PATH = pwd + "res/drawable/lena.png";
        ViSPTestRunner.CHESS_PATH = pwd + "res/drawable/chessboard.jpg";
        ViSPTestRunner.LBPCASCADE_FRONTALFACE_PATH = pwd + "res/raw/lbpcascade_frontalface.xml";

        assert(new File(ViSPTestRunner.LENA_PATH).exists());
        assert(new File(ViSPTestRunner.CHESS_PATH).exists());
        assert(new File(ViSPTestRunner.LBPCASCADE_FRONTALFACE_PATH).exists());
        ...
        rgbLena = Imgcodecs.imread(ViSPTestRunner.LENA_PATH);
        grayChess = Imgcodecs.imread(ViSPTestRunner.CHESS_PATH, 0);
    ...
    protected void runTest() throws Throwable {
        ...
        if (isTestCaseEnabled) {
            try {
                ...
                ViSPTestRunner.Log(TAG + " :: " + "Test case \"" + this.getClass().getName() + "\" skipped!");
                assertTrue(true);
            }
        } else {
            ViSPTestRunner.Log(TAG + " :: " + "Test case \"" + this.getClass().getName() + "\" disabled!");
        }
    }
    ...
    protected static String readFile(String path) {
        ...
        return result.toString();
            ...
            ViSPTestRunner.Log("Failed to read file \"" + path
    ...
    protected static void writeFile(String path, String content) {
        ...
        try {
            ...
            ViSPTestRunner.Log("Failed to write file \"" + path
                    + "\". Exception is thrown: " + e);
        } finally {
            if (stream != null)
                try {
                    ...
                    ViSPTestRunner.Log("Exception is thrown: " + e);
                }
        }
    }
