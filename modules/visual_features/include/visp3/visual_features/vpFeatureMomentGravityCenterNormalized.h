...
public:
   ...
   */
  const std::string momentName() const override { return "vpMomentGravityCenterNormalized"; }

  /*!
   * Feature name.
   */
  const std::string name() const override { return "vpFeatureMomentGravityCenterNormalized"; }
 ...
 *
 * \brief Functionality computation for centered and normalized moment feature.
 * Computes the interaction matrix associated with vpMomentGravityCenterNormalized.
 *
 ...
 *   \left[
 *   \begin{array}{c}
 *   -Ax_{{n}}\theta+ \left( x_{{n}}e_{{1,1}}-y_{{n}} \right) B-a_{{n}}C \\
 ...
 *   \left[
 *   \begin{array}{c}
 *   \left( 1-\theta \right) y_{{n}}A+y_{{n}}e_{{1,1}}B \\
 *   \noalign{\medskip} \left( -x_{{n}}+y_{{n}}e_{{1,1}}
 *   \right)
 ...
 *   {
 *   \left[
 *   \begin {array}{c} -a_{{n}}C-1/2\,Ax_{{n}}-By_{{n}} \\
 ...
 * \f$ L_{x_{n}} \f$ and vpFeatureMomentGravityCenterNormalized::selectYn for \f$L_{y_{n}} \f$.
