...
public:
   ...
   */
  const char *momentName() const override { return "vpMomentGravityCenterNormalized"; }

  /*!
   * Feature name.
   */
  const char *name() const override { return "vpFeatureMomentGravityCenterNormalized"; }
