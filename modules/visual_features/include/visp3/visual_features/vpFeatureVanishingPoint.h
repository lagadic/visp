...
/*!
  ...
  - Either the cartesian coordinates of the vanishing point obtained from the intersection of two lines;
  ...
  - Rather the polar coordinates of the vanishing point obtained from the polar coordinates of the two lines
    \f$(\rho_1, \theta_1)\f$ and \f$(\rho_2, \theta_2)\f$;
    in that case \f$ {\bf s} = (1/\rho, \alpha) \f$ with:
