...
vpDirectShowDevice * vpDirectShowGrabber::deviceList = NULL;

/*!
	Converts a HRESULT into the corresponding error message
*/
void vpDirectShowGrabber::HRtoStr(string& str)
{
...
*/
bool vpDirectShowGrabber::initDirectShow()
{
...
/*!
	...
	\return Was the operation successful
*/
bool vpDirectShowGrabber::enumerate(CComPtr<IEnumMoniker>& ppVideoInputEnum)
{
...
/*!
	...
	\return Was the operation successful
*/
bool vpDirectShowGrabber::createDeviceList(CComPtr<IEnumMoniker>& ppVideoInputEnum)
{
...
/*!
	...
	\return Was the operation successful
*/
bool vpDirectShowGrabber::getDevice(unsigned int n, CComPtr<IBaseFilter>& ppDevice)
{
...
/*!
	...
	\return Was the operation successful
*/
bool vpDirectShowGrabber::getFirstUnusedDevice(CComPtr<IBaseFilter>& ppDevice)
{
	unsigned int n=0;
	bool found=false;
...
/*!
	...
	\return Was the operation successful
*/
bool vpDirectShowGrabber::createGraph()
{
...
/*!
	...
	\return Was the operation successful
*/
bool vpDirectShowGrabber::createSampleGrabber(CComPtr<IBaseFilter>& ppGrabberFilter)
{
...
/*!
	...
	\return Was the operation successful
*/
bool vpDirectShowGrabber::connectSourceToGrabber(CComPtr<IBaseFilter>& pCapSource, CComPtr<IBaseFilter>& pGrabberFilter)
{
...
/*!
	...
	\return Was the operation successful
*/
bool vpDirectShowGrabber::removeAll() 
{
