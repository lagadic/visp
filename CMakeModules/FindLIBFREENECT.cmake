...
IF(WIN32)
  FIND_PATH(LIBFREENECT_HPP_INCLUDE_DIR libfreenect.hpp
	...
	$ENV{LIBFREENECT_HPP_INCLUDE_PATH}
	$ENV{LIBFREENECT_H_INCLUDE_PATH}
    )
...
IF(LIBFREENECT_LIBRARY AND LIBFREENECT_HPP_INCLUDE_DIR AND LIBFREENECT_H_INCLUDE_DIR)
  SET(LIBFREENECT_INCLUDE_DIR ${LIBFREENECT_HPP_INCLUDE_DIR} ${LIBFREENECT_H_INCLUDE_DIR})
