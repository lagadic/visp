 ...
 * ===============
 *
 *  $Id: testServoEllipse.cpp,v 1.3 2005-06-29 15:57:35 fspindle Exp $
 *
 * Description
 * ============
...
/*!
  \example testServoCircle.cpp
  \brief tests the control law, eye-in-hand control, velocity computed in the camera frame visual feature is a circle
*/
