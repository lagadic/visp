 ...
 */
void usage(char *name, char *badparam, unsigned board, unsigned fps,
...
\n\
SYNOPSIS\n\
  %s [-b <board=[0-7]>] [-f <fps=25|50>] [-i <input=0|1|2|3> \n\
...
*/
bool getOptions(int argc, char **argv, unsigned &board, unsigned &fps,
