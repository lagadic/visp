...
if (NOT EXISTS "${ANDROID_NDK}/source.properties")
    message(FATAL_ERROR "Missing file: ${ANDROID_NDK}/source.properties. Please use NDK r16+.")
endif ()
...
include_directories("${ANDROID_NDK}/sysroot/usr/include") # TODO akshay made some edits
include_directories("${ANDROID_NDK}/sysroot/usr/include/x86_64-linux-android" # TODO akshay made some edits
        )
...
# TODO added by akshay. for debugging
