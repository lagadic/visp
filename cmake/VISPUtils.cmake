...
function(vp_find_dataset found)
  ...
  if(DEFINED ENV{VISP_INPUT_IMAGE_PATH})
    if(EXISTS "$ENV{VISP_INPUT_IMAGE_PATH}/${file_to_test}")
      set(_found TRUE)
      message("1 file ${file_to_test} found in $ENV{VISP_INPUT_IMAGE_PATH}/${file_to_test}")
    elseif(EXISTS "$ENV{VISP_INPUT_IMAGE_PATH}/ViSP-images/${file_to_test}")
      set(_found TRUE)
      message("2 file ${file_to_test} found in $ENV{VISP_INPUT_IMAGE_PATH}/ViSP-images/${file_to_test}")
    elseif(EXISTS "$ENV{VISP_INPUT_IMAGE_PATH}/visp-images/${file_to_test}")
      set(_found TRUE)
      message("3 file ${file_to_test} found in $ENV{VISP_INPUT_IMAGE_PATH}/visp-images/${file_to_test}")
    endif()
  endif()
