...
macro(vp_check_cpu_optimization cpu_optim)
  ...
  if(HAVE_SSE2)
    list(APPEND __cpu_optim "${__cpu_optim} SSE2")
  endif()
  if(HAVE_SSE3)
    list(APPEND __cpu_optim "${__cpu_optim} SSE3")
  endif()
  if(HAVE_SSSE3)
    list(APPEND __cpu_optim "${__cpu_optim} SSSE3")
  endif()
  if(HAVE_SSE4_1)
    list(APPEND __cpu_optim "${__cpu_optim} SSE4_1")
  endif()
  if(HAVE_SSE4_2)
    list(APPEND __cpu_optim "${__cpu_optim} SSE4_2")
  endif()
  if(HAVE_NEON)
    list(APPEND __cpu_optim "${__cpu_optim} NEON")
  endif()
