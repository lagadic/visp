...
if(MSVC)
  ...
  if(CMAKE_CL_64)
    list(APPEND REALSENSE2_LIB_SEARCH_PATH "C:/librealsense2/bin/x64")
    list(APPEND REALSENSE2_LIB_SEARCH_PATH $ENV{REALSENSE2_HOME}/bin/x64)
    list(APPEND REALSENSE2_LIB_SEARCH_PATH $ENV{REALSENSE2_DIR}/bin/x64)
  else()
    list(APPEND REALSENSE2_LIB_SEARCH_PATH "C:/librealsense2/bin/x86")
    list(APPEND REALSENSE2_LIB_SEARCH_PATH $ENV{REALSENSE2_HOME}/bin/Win32)
    list(APPEND REALSENSE2_LIB_SEARCH_PATH $ENV{REALSENSE2_DIR}/bin/Win32)
  endif()
...
if(MSVC)
  find_library(REALSENSE2_LIBRARIES_OPT
    NAMES realsense2
    PATHS
      ${REALSENSE2_LIB_SEARCH_PATH}
  )
  find_library(REALSENSE2_LIBRARIES_DBG
    NAMES realsense2-d
    PATHS
      ${REALSENSE2_LIB_SEARCH_PATH}
  )
  if(REALSENSE2_LIBRARIES_DBG AND REALSENSE2_LIBRARIES_OPT)
    set(REALSENSE2_LIBRARIES optimized ${REALSENSE2_LIBRARIES_OPT})
    list(APPEND REALSENSE2_LIBRARIES debug ${REALSENSE2_LIBRARIES_DBG})
  elseif(REALSENSE2_LIBRARIES_OPT)
    set(REALSENSE2_LIBRARIES ${REALSENSE2_LIBRARIES_OPT})
  elseif(REALSENSE2_LIBRARIES_DBG)
    set(REALSENSE2_LIBRARIES ${REALSENSE2_LIBRARIES_DBG})
  endif()

  mark_as_advanced(REALSENSE2_LIBRARIES_OPT REALSENSE2_LIBRARIES_DBG)
else()
