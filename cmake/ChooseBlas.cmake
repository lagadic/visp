...
if(MKL_FOUND)
  set(BLAS/LAPACK "MKL" CACHE STRING "Selected BLAS library")
elseif(OpenBLAS_FOUND)
  set(BLAS/LAPACK "Open" CACHE STRING "Selected BLAS library")
elseif(ATLAS_FOUND)
  set(BLAS/LAPACK "Atlas" CACHE STRING "Selected BLAS library")
elseif(LAPACK_C_FOUND)
  set(BLAS/LAPACK "Netlib" CACHE STRING "Selected BLAS library")
else()
...
if(AVAILABLE_VENDOR)
  ...
  if(MKL_FOUND)
    set_property(CACHE BLAS/LAPACK APPEND_STRING PROPERTY STRINGS "MKL;")
  endif()
  if(OpenBLAS_FOUND)
    set_property(CACHE BLAS/LAPACK APPEND_STRING PROPERTY STRINGS "Open;")
  endif()
  if(ATLAS_FOUND)
    set_property(CACHE BLAS/LAPACK APPEND_STRING PROPERTY STRINGS "Atlas;")
  endif()
  if(LAPACK_C_FOUND)
    set_property(CACHE BLAS/LAPACK APPEND_STRING PROPERTY STRINGS "Netlib")
  endif()
