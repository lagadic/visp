...
if(WITH_CPPBASE64)
  set(CPPBASE64_LIBRARY visp_cppbase64)
  add_subdirectory("${VISP_SOURCE_DIR}/3rdparty/cpp-base64")
  set(CPPBASE64_INCLUDE_DIRS "${${CPPBASE64_LIBRARY}_SOURCE_DIR}" "${${CPPBASE64_LIBRARY}_BINARY_DIR}")
  set(CPPBASE64_LIBRARIES ${CPPBASE64_LIBRARY})
  set(CPPBASE64_VERSION ${CPPBASE64_MAJOR_VERSION}.${CPPBASE64_MINOR_VERSION}.${CPPBASE64_PATCH_VERSION})
endif()
