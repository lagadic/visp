...
if(USE_CATCH2)
  ...
  if(Catch2_FOUND)
    ...
    set(CATCH2_VERSION "${Catch2_VERSION_MAJOR}.${Catch2_VERSION_MINOR}.${Catch2_VERSION_PATCH}")
    ...
    vp_clear_vars(Catch2_VERSION_MAJOR Catch2_VERSION_MINOR Catch2_VERSION_PATCH Catch2_LIBRARIES Catch2_INCLUDE_DIRS)
