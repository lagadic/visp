...
if(USE_APRILTAG)
  ...
  if(MyApriltag_FOUND AND (MyApriltag_VERSION VERSION_LESS_EQUAL "3.3.0"))
    message(STATUS "Found system apriltag but version \"${MyApriltag_VERSION}\" too old")
    set(MyApriltag_FOUND FALSE)
  endif()
  if(apriltag_FOUND AND (${apriltag_VERSION_MAJOR}.${apriltag_VERSION_MINOR}.${apriltag_VERSION_PATCH} VERSION_LESS_EQUAL "3.3.0"))
    message(STATUS "Found system apriltag but version \"${apriltag_VERSION_MAJOR}.${apriltag_VERSION_MINOR}.${apriltag_VERSION_PATCH}\" too old")
    set(apriltag_FOUND FALSE)
  endif()
  if(apriltag_FOUND)
