...
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "^(loongarch64.*|LOONGARCH64.*)")
  ...
  # Fallback: use the CMake -A platform argument for UWP/cross-compilation scenarios
  # where CMAKE_SYSTEM_PROCESSOR may not be set correctly
  if(CMAKE_GENERATOR_PLATFORM MATCHES "^(ARM64|arm64)$")
    message(STATUS "ViSP: processor fallback via CMAKE_GENERATOR_PLATFORM -> AARCH64")
    set(AARCH64 1)
  elseif(CMAKE_GENERATOR_PLATFORM MATCHES "^(ARM|arm)$")
    message(STATUS "ViSP: processor fallback via CMAKE_GENERATOR_PLATFORM -> ARM")
    set(ARM 1)
  elseif(CMAKE_GENERATOR_PLATFORM MATCHES "^(x64|X64)$")
    message(STATUS "ViSP: processor fallback via CMAKE_GENERATOR_PLATFORM -> X86_64")
    set(X86_64 1)
  elseif(CMAKE_GENERATOR_PLATFORM MATCHES "^(Win32|x86)$")
    message(STATUS "ViSP: processor fallback via CMAKE_GENERATOR_PLATFORM -> X86")
    set(X86 1)
  else()
